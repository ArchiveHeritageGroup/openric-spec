...
A rico:Production activity (type_id=production) with a date range. Exercises: production branch of the activity schema's @type pattern; mapping spec §6.5 production→Production.
